...
def calculate_dog_years():
    ...
    if dog_age < 0:
        ...
        return
    if dog_age == 0:
        print("A dog's age cannot be zero.")
    elif dog_age == 1:
        dog_years = 10
...
def determine_season():
    ...
    day_str = input('Enter the day of the month: ').strip()
    ...
    if month not in months:
        print('Invalid month. Please enter a valid three-letter month abbreviation (e.g., Jan, Feb, Mar).')
        return
...
def guess_number():
    ...
    for attempt in range(1, max_attempts + 1):
        guess_str = input(f'Attempt {attempt}: Enter your guess: ').strip()
        ...
        if guess == target:
            ...
            print('Guess is out of range (1-100).')
